...
use App\Http\Controllers\Admin\PointSetupController;
...
use App\Http\Controllers\Admin\PointBalanceReportController;
...
use App\Http\Controllers\Frontend\PointController as FrontendPointController;
...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'apiKey', 'auth:sanctum', 'localization'])->group(function () {
    ...
    Route::prefix('setting')->name('setting.')->group(function () {
        ...
        Route::prefix('point-setup')->name('point-setup.')->group(function () {
            Route::get('/', [PointSetupController::class, 'index']);
            Route::match(['put', 'patch'], '/', [PointSetupController::class, 'update']);
        });
    ...
    Route::prefix('point-balance-report')->name('point-balance-report.')->group(function () {
        Route::get('/', [PointBalanceReportController::class, 'index']);
        Route::get('/export', [PointBalanceReportController::class, 'export']);
    });
...
Route::prefix('frontend')->name('frontend.')->middleware(['installed', 'apiKey', 'localization'])->group(function () {
    ...
    Route::prefix('points')->name('points.')->group(function () {
        Route::get('/user-points-checking', [FrontendPointController::class, 'userPointsChecking']);
    });
