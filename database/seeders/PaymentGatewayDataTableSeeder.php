...
class PaymentGatewayDataTableSeeder extends Seeder
{
    ...
    public array $gateways = [
        ...
        [
            ...
            "options" => [
                [
                    "option"     => 'selcom_client_id',
                    "value"      => 'TILL61100133',
                ],
                [
                    "option"     => 'selcom_client_secret',
                    "value"      => '01b69e-1f46f9-46d0b3-e580cf-9f4255-a4',
                ],
                [
                    "option"     => 'selcom_api_key',
                    "value"      => 'TILL61100133-fa42a74c816d4139839e8d591b015b3a',
                ],
                [
                    "option"     => 'selcom_mode',
                    "value"      => GatewayMode::SANDBOX,
