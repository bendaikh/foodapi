...
class InstallerService
{
    public function siteSetup(Request $request): void
    {
        ...
        $envService->addData([
            ...
            'MIX_API_KEY' => 'default-api-key-' . md5($request->app_url)
        ]);
    ...
    public function databaseSetup(Request $request): bool
    {
        ...
        if ($connection) {
            ...
            // Clear config before migration to ensure fresh database connection
            Artisan::call('config:clear');
            
            // Set longer timeout for migration and seeding
            ...
            try {
                ...
                // Log error but continue - some seeders might fail but basic installation can work
                \Log::error('Installation seeding error: ' . $e->getMessage());
            }
