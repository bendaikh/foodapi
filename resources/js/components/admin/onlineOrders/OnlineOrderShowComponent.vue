            ...
            <div class="col-12">
                <div class="db-card p-1">
                    <ul class="flex flex-col gap-2 p-3 border-b border-dashed border-[#EFF0F6]">
                        ...
                        <li v-if="order.point_discount_price > 0"
                            class="flex items-center justify-between text-heading">
                            <span class="text-sm leading-6 capitalize">{{ $t('label.points') }} {{ $t('label.discount')
                                }}</span>
                            <span class=" text-sm leading-6 capitalize"> <span class="text-[#1AB759]">{{
                                order.point_discount_currency_price }} </span></span>
                        </li>
