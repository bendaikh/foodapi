        ...
        <div class="db-card-body">
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title required" for="point_setup">{{ $t("label.reward_points") }}</label>
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input :value="enums.activityEnum.ENABLE" v-model="form.site_point_setup"
                                        id="point_setup_enable" type="radio" class="custom-radio-field" />
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="point_setup_enable" class="db-field-label">{{ $t("label.enable") }}</label>
                            </div>
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input :value="enums.activityEnum.DISABLE" v-model="form.site_point_setup" type="radio"
                                        id="point_setup_disable" class="custom-radio-field" />
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="point_setup_disable" class="db-field-label">{{
                                    $t("label.disable")
                                }}</label>
                            </div>
                        </div>
                        <small class="db-field-alert" v-if="errors.site_point_setup">{{
                            errors.site_point_setup[0]
                        }}</small>
                    </div>
        ...
        list: function () {
            ...
            this.$store.dispatch('site/lists').then(res => {
                this.form = {
                    ...
                    site_point_setup:res.data.data.site_point_setup
                }
                this.loading.isActive = false;
            }).catch((err) => {
                this.loading.isActive = false;
