...
export default {
    ...
    methods: {
        ...
        orderSubmit: function (e, is_whats_app = false) {
            ...
            this.checkoutProps.form.total = parseFloat(this.subtotal + this.checkoutProps.form.delivery_charge - this.checkoutProps.form.discount - this.checkoutProps.form.point_discount_amount).toFixed(this.setting.site_digit_after_decimal_point);
